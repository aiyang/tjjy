...
- (id)initWithOriginY:(CGFloat)y Titles:(NSArray *)titles delegate:(id)delegate
{
    ...
    if (MAINSCREEN_WIDTH>MAINSCREEN_HEIGHT) {
        rect4View = CGRectMake(.0f, y, MAINSCREEN_HEIGHT, HYSegmentedControl_Height);
    }
...
//        }
        ...
        //  bottom lineView
        //
        _bottomLineView = [[UIView alloc] initWithFrame:CGRectMake(5.0f, HYSegmentedControl_Height-2, width4btn-10.0f, 2.0f)];
