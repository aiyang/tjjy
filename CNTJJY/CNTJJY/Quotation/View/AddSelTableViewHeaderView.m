...
@implementation AddSelTableViewHeaderView
...
- (void)setXib
{
    UIView *containerView = [[[UINib nibWithNibName:@"AddSelTableViewHeaderView" bundle:nil] instantiateWithOwner:self options:nil] objectAtIndex:0];
